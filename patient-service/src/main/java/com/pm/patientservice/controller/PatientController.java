...
public class PatientController {
    ...
    @PostMapping
    public ResponseEntity<PatientResponseDTO> createNewPatient(@Validated(CreatePatientValidationGroup.class) @RequestBody PatientRequestDTO patientRequestDTO) {
